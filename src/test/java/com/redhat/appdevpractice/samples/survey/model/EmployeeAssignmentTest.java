...
public class EmployeeAssignmentTest {
    ...
    public void setup() {
        ...
        john = new EmployeeAssignment("john@redhat.com", "consultant", "UUID123", 
            LocalDate.now(), LocalDate.now().plusDays(60));
        
        sara = new EmployeeAssignment("sara@redhat.com", "consultant", "UUID312",
    ...
    public void hashCodeShouldBeEqual() {
        ...
        assertNotEquals(john.hashCode(), sara.hashCode(), "Employees with different email should not have the same hashCode.");
    }
}